...
class Job:
    ...
    @classmethod
    def create(cls, *, name: str, cron_schedule: str, workflow: Workflow, workflow_args: dict | None = None, timezone: str):
        """
        Parameters
        ----------
        name
        ...
        job = scheduler_v1.Job(
            ...
            http_target=scheduler_v1.HttpTarget(
                ...
                oauth_token=scheduler_v1.OAuthToken(service_account_email=get_service_account_email()),
                body=body,
            )
        )
    ...
    def state(self) -> Literal['ACTIVE', 'ENABLED', 'PAUSED', 'DISABLED', 'STATE_UNSPECIFIED']:
        self._refresh()
