...
>>>
>>> from cloudly.biglist import read_parquet_file
...
>>> from cloudly.biglist import write_arrays_to_parquet, read_parquet_file
>>> import random
>>> from cloudly.upathlib import LocalUpath
>>> N = 10000
>>> path = LocalUpath('/tmp/a/b/c/d')
...
>>> from cloudly.biglist import write_pylist_to_parquet
...
.. autodata:: cloudly.biglist._util.Element


.. autoclass:: cloudly.biglist.Seq
...
.. autoclass:: cloudly.biglist._biglist.BiglistBase
